...
export const offers = [
  ...
  { id: 'content', name: 'CONTENT', title: 'Donner du fond à vos prises de parole', description: 'Concevoir et rédiger les contenus qui expliquent votre activité, valorisent vos expertises et nourrissent le dialogue avec vos publics. Articles, publications, contenus web et audio : une même exigence éditoriale, en communication interne comme externe.', items: ['Articles, dossiers et livres blancs', 'Magazines, newsletters et rapports d’activité', 'Contenus de sites et pages d’expertise', 'Cas clients, interviews et portraits', 'Tribunes et prises de parole dirigeantes', 'Podcasts et récits audio', 'Adaptations pour les réseaux sociaux'] },
